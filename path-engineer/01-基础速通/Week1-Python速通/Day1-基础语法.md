...
- [ ] 验证 Python 环境能跑（终端 `python3 --version`）
- [ ] 通读本文档，对照 Java 找差异点
- [ ] 把上面的代码片段**手敲一遍**（不要复制！至少敲 3 段）
- [ ] 完成 [`练习/day1_练习.py`](./练习/day1_练习.py)（约 8 道小题）
- [ ] 在终端运行 `python3 day1_练习.py` 看输出对不对
...
- [ ] 解释 Python 缩进 vs Java 花括号
- [ ] 写一个带默认参数的函数
- [ ] 写一个简单的类（含构造方法和实例方法）
- [ ] 用 `enumerate` 和 `zip` 遍历集合
- [ ] 写一个 f-string 格式化输出
